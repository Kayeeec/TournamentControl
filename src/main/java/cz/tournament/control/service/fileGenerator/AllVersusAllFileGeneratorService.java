...
public class AllVersusAllFileGeneratorService extends FileGeneratorService {
    ...
    public File generateAllVersusAllSpreadSheet(AllVersusAll tournament) throws FileNotFoundException, IOException {
        ...
        //match evaluation
        TableModel matchEvaluation_model = getAllVersusAllMatchModel(tournament);
    ...
    private TableModel getAllVersusAllMatchModel(AllVersusAll tournament) {
        ...
        String[] allVersusAll_match_cols = getAllVersusAllMatchCols(maxSetCount);
        Object[][] data = dataList.toArray(new Object[][] {});
        return new DefaultTableModel(data, allVersusAll_match_cols);
    }

    private String[] getAllVersusAllMatchCols(int maxSetCount) {
